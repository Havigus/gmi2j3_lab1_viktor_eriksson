...
class FromRomanBadInput(unittest.TestCase):
    ...
    def testBlanks(self):
        '''from_roman should fail with blank input'''
        self.assertRaises(roman.InvalidRomanNumeralError, roman.from_roman, '')

    #NOTE:
    #Missing testcase by the author of Dive into Python 3, added by me
    def test_lowercase(self):
        '''from_roman should fail with lowercase input'''
        self.assertRaises(roman.InvalidRomanNumeralError, roman.from_roman, 'mcmxcix')
